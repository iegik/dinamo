...
module.exports = function(passport) {
    ...
    function(req, email, password, done) {
        ...
        process.nextTick(function() {
            User.findOne({ 'emails.value' :  email }, function(err, user) {
    ...
    function(req, email, password, done) {
        ...
        process.nextTick(function() {
            ...
            User.findOne({'emails.value': email}, function(err, existingUser) {
                ...
                if(req.user) {
                    ...
                    user.emails.push({value:email || user.username});
    ...
    function (req, token, err, profile, done) {
    // asynchronous verification, for effect...
    process.nextTick(function () {
      if (profile && profile.id === '582937557') {
        profile.roles = [{value:'admin'}];
      }
      if(profile){
        profile.facebook = ({
          id: profile.id,
